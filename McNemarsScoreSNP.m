function [chi_sqr,chi_sqr_cc,p_exact,Qa,Qb,Qc,Qd] = McNemarsScoreSNP(AlleleHighFreq, ...
...
for i = 1:numel(control_no_effect)
   ...
   if (case_test == 100 || control_test == 100) % N or 0, no score for animal(s)
       return  % don't score pair when there is no score for the alleles for one or both animals
