function [chi_sqr,chi_sqr_cc,p_exact,Qa,Qb,Qc,Qd] = McNemarsScoreSNPDoubleA(AlleleHighFreq, ...
...
for i = 1:numel(control_no_effect)
    control_test = doubleAllelePresent(AlleleHighFreq,control_no_effect(i));
    case_test = doubleAllelePresent(AlleleHighFreq,case_affected(i));
